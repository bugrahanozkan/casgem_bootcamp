...
public class BootcampProjectApplication {
	...
	@Bean // modelmapper kullanacağımız zaman modelmapper sınıfını newler.
	...
	public ErrorDataResult<Object> handleValidationExceptions(MethodArgumentNotValidException methodArgumentNotValidException){
		...
		ErrorDataResult<Object> errorDataResult= new ErrorDataResult<>(validationErrors,"VALİDATİON.EXCEPTİON");
